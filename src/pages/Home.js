  ...
  return (
    <>
      ...
      <section id="gridRow" className="flex flex-col lg:flex-row sm:items-stretch justify-stretch items-center bg-nbgreylight rounded-lg max-w-screen-lg overflow-clip relative hover:bg-slate-200 transition-colors delay-150">
        <div id="gridCol"
          className="min-w-full sm:min-w-0 w-full lg:ml-5 lg:my-5 ring-1 ring-gray-900/5 ring-inset relative">
          <div class="peer h-full overflow-hidden bg-white lg:rounded-md aspect-h-1 aspect-w-2 active:aspect-h-3 active:aspect-w-2 transition-all active:max-h-40 active:">
          ...
          <svg className='z-10 absolute bottom-2 right-2 h-5 w-5 peer-active:hidden transition-all stroke-nbgreylight hover:stroke-nbgreenmain hover:h-6 hover:w-6 duration-700' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="3" stroke="currentColor">
        ...
        <div id="gridCol" className="flex-auto flex flex-col justify-between px-7 pb-5 lg:pt-5">
          ...
          <div id="gridCol" className='flex flex-col'>
            ...
            <div class="min-w-40 w-52 max-w-fit sm:w-max overflow-x-scroll sm:border-r-transparent border-r-2 border-nbgreymain mb-3 scroll-pr-6">
              <div class="flex flex-row items-center sm:items-center justify-between gap-4 overflow-visible py-1">
                <div class="flex flex-row items-end sm:items-center justify-start gap-4 overflow-visible">
                  <Link className='flex flex-row gap-2 items-center group/button'>
                    ...
                    <h3
                      className="group-hover/button:text-nbgreenmain group-active/button:text-nbgreenlight group-disabled/button:text-nbgreylight  font-bold font-h2-title text-base text-left text-nbgreydark leading-none tracking-tight cursor-pointer text-nowrap sm:text-balance truncate">
          ...
          <div
            ...
            <div className="px-6 py-5 flex flex-col gap-2">
              <div class="flex flex-col gap-1 sm:gap-2 group/island">
                <div className="group/labels flex flex-col sm:flex-row justify-between gap-1">
                  <div class="pointer-events-none mx-auto sm:mx-0">
