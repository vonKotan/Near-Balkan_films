...
const User = ({ user, targetDate, haveWon }) => {
  return (
    <>
      <div className="gap-8 grid grid-cols-3 min-w-full">
        <div className="flex flex-col flex-wrap justify-center items-center col-span-auto bg-nbgreylight rounded-lg min-w-full min-h-fit p-6">
          <img
          ...
          <div className="buttons relative flex items-center justify-center gap-6 mt-6">
