        ...
        <>
            <div className="flex flex-col justify-center items-center gap-6 bg-teal-600 mb-7 p-6 lg:pt-8 lg:pb-10 rounded-lg w-full min-w-fit max-w-screen-lg">
                ...
                <div className="flex lg:flex-col justify-center items-center gap-1 order-3 lg:order-none">
                    <div className='flex lg:flex-row flex-col flex-wrap justify-center items-center lg:items-baseline gap-x-2 text-center'>
                        <h2 className='font-h2-title font-semibold text-center text-ellipsis text-lg text-nbwhite sm:text-xl md:text-2xl underline underline-offset-2 leading-6 decoration-2 decoration-nbgreenmain'>{t("adbloc.publicity")}</h2>
                        <span className='lg:block hidden font-h2-title font-semibold text-lg text-nbwhite sm:text-xl md:text-2xl'>+</span>
                        <h2 className='font-h2-title font-semibold text-center text-ellipsis text-lg text-nbwhite sm:text-xl md:text-2xl underline underline-offset-2 leading-6 decoration-2 decoration-nbgreenmain'>{t("adbloc.networking")}</h2>
                        <span className='lg:block hidden font-h2-title font-semibold text-lg text-nbwhite sm:text-xl md:text-2xl'>+</span>
                        <h2 className='font-h2-title font-semibold text-center text-ellipsis text-lg text-nbwhite sm:text-xl md:text-2xl underline underline-offset-2 leading-6 decoration-2 decoration-nbgreenmain'>{t("adbloc.funding")}</h2>
                        <h2 className='order-first lg:order-none bg-nbpurplemain mb-1.5 sm:mb-0 ml-1 px-1 -py-2 font-h2-title font-semibold text-base text-nbwhite sm:text-xl md:text-2xl leading-4'>{t("adbloc.for_filmmakers")}</h2>
                    </div>
                    <div className="block lg:hidden bg-nbgreymain mx-3 w-px max-w-screen-lg h-24 overflow-clip"></div>
                    <div className='flex lg:flex-row flex-col flex-wrap justify-center items-center lg:items-baseline gap-x-2 text-center'>
                        <h2 className='font-h2-title font-semibold text-center text-ellipsis text-lg text-nbwhite sm:text-xl md:text-2xl underline underline-offset-2 leading-6 decoration-2 decoration-nbgreenmain'>{t("adbloc.personal_input")}</h2>
                        <span className='lg:block hidden font-h2-title font-semibold text-lg text-nbwhite sm:text-xl md:text-2xl'>+</span>
                        <h2 className='font-h2-title font-semibold text-center text-ellipsis text-lg text-nbwhite sm:text-xl md:text-2xl underline underline-offset-2 leading-6 decoration-2 decoration-nbgreenmain'>{t("adbloc.exclusivity")}</h2>
                        <span className='lg:block hidden font-h2-title font-semibold text-lg text-nbwhite sm:text-xl md:text-2xl'>+</span>
                        <h2 className='font-h2-title font-semibold text-center text-ellipsis text-lg text-nbwhite sm:text-xl md:text-2xl underline underline-offset-2 leading-6 decoration-2 decoration-nbgreenmain'>{t("adbloc.patronage")}</h2>
                        ...
                        <h2 className='order-first lg:order-none lg:hidden bg-nborangemain mb-1.5 sm:mb-0 ml-1 px-1 -py-2 font-h2-title font-semibold text-base text-nbwhite sm:text-xl md:text-2xl leading-4'>{t("adbloc.for_consumers")}</h2>
                    </div>
                </div>
