...
export const GraphFieldRace = ({ movie, targetDate, haveWon }) => {
    ...
    console.log(Math.floor(Math.floor(movie.moneyMin ?? 0) / Math.floor(movie.moneygoal ?? 0) * 100));
                    ...
                    <div class="flex flex-col gap-2 sm:gap-2 group/island">
                        <div className="flex sm:flex-row flex-col justify-between gap-2 group/labels peer/labels">
                            <div class="mx-0 leading-none pointer-events-none select-none">
                                {haveWon && (
                                    <>
                                        <span className="font-bold text-nbgreenmain text-sm sm:text-base underline transition-all decoration-4">{movie.collected ?? 0}<span className="font-thin">HUF</span></span>
                                        <span className="inline">
                                            <span className="font-bold text-nbpurplemain text-sm sm:text-base">+</span>
                                            <span className="font-bold text-nbpurplemain text-sm sm:text-base underline transition-all decoration-4">230000<span className="font-thin">HUF</span></span>
                                        </span>
