...
export const PosterContainerSmall = ({ movie }) => {
    return (
        <div id="gridCol"
            ...
            <div className="bg-white lg:rounded-md aspect-w-2 active:aspect-w-2 aspect-h-1 h-full active:aspect-h-3 transition-all overflow-clip">
                <img src={movie.image} alt="poster" className="w-full h-full select-none object-center object-cover" />
            </div>
...
export const PosterContainer = ({ movie }) => {
    return (
        <div id="gridCol"
            ...
            <div className="bg-white lg:rounded-md aspect-w-2 active:aspect-w-2 min-w-max aspect-h-1 h-full active:aspect-h-3 transition-all overflow-clip">
                <img src={movie.image} alt="poster" className="w-full h-full select-none object-center object-cover" />
            </div>
