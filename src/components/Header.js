  ...
  return (
    <header>
      <Root id="navbar" className='flex justify-between lg:justify-center items-center px-6 lg:px-12 min-h-16'>
        <ul className="lg:flex items-center gap-6 hidden min-w-max basis-0 grow menuInside shrink-0">
          <Link
        ...
        <Link
          to='/' className="flex justify-center items-end gap-2 mr-4 lg:ml-6 transition-all nbLogo shrink">
          <svg className="w-12 h-8 group/logo logoVectors2 shrink-0" xmlns="http://www.w3.org/2000/svg">
            <path className="group-hover/logo:fill-nbgreendark fill-nbgreenmain"
            ...
            <path className="group-hover/logo:fill-nbgreenmain fill-nbgreendark"
          ...
          <svg className="w-16 h-7 group/logotext logoTextVectors2 shrink-0" xmlns="http://www.w3.org/2000/svg">
            <g className="group-hover/logotext:fill-nbgreenmain fill-nbgreendark">
              <path
